...
Product_Type_string = st.selectbox("Product ID", ["FD", "NC", "DR"])

# NEW FIELD REQUIRED BY YOUR DATASET SCHEMA
Product_Key_Number = st.number_input("Product Key Number", min_value=0, value=15)
...
product_data = {
    ...
    "Product_Type_string": Product_Type_string,
    "Product_Key_string": Product_Id_char,     
    "Product_Key_Number": Product_Key_Number
}
